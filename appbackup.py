...
# Inicializar predictor de rango
...
API_TO_MODEL_STATS = {
    ...
    # Las custom_metrics ya están bien mapeadas
}
...
def main():
    ...
    with col1:
        individual = st.button("🎮 Entrenamiento Individual", use_container_width=True)
    with col2:
        teams = st.button("👥 Análisis de Equipo", use_container_width=True)
    st.markdown('</div>', unsafe_allow_html=True)
    ...
    # Selección de jugador y configuración de rangos
    if st.session_state['show_player_selection']:
